...
# ========= 配置项 =========
CSV_PATH = Path('Hangzhou_Multicast_Unicast.csv')
APPLY_ONLINE_LOGO = 2  # 0: 本地 logo, 1: 在线 logo, 2: 同时输出
OUTPUT_M3U = Path('Hangzhou_Multicast_Unicast.m3u')
OUTPUT_M3U_ONLINE_LOGO = Path('Hangzhou_Multicast_Unicast_ONLINE_LOGO.m3u')
OUTPUT_TXT = Path('Hangzhou_Multicast_Unicast.txt')
